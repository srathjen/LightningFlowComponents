({
    ...
    resetLookupValues: function(component, event){
        ...
        component.set('v.optionSelection','');
    },
    ...
    processDiagnosis: function(leadData,component,Qualifying_Diagnosis,Qualifying_ICD){
        ...
        _this.getConditionDescMawName(component,leadToUpdate, leadData);
    },
    
     getConditionDescMawName: function(component,leadToUpdate,leadData){
        var _this = this;
        var actionName = "c.getConditionDescInfo";
        var params = {
            "qc_Diagnosis": leadToUpdate.Qualifying_Diagnosis
        };
        _this.callAction(component, actionName, params, function(response){
             leadToUpdate.mawName = response;
            _this.saveQualifyingDiagnosis(component, leadToUpdate, leadData);
        });              
    },
    
    saveQualifyingDiagnosis: function(component, leadToUpdate, leadData){
        var _this = this,
            actionName = "c.updateQualifyingDiagnosis";
