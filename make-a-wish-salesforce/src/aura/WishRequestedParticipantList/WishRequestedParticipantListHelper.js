...
({
    initialize: function (component, event, helper) {
        ...
        var wishAffiliationCategory = "Requested Participant";
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === 'SUCCESS') {
                component.set("v.wishRequestedParticipants", dataMap['wishAffiliations']);
                ...
                component.set("v.wishAffiliationTypes", dataMap['wishAffiliationTypes']);
                var newWishRequestedParticipant = component.initializeNewWishAffiliation(component);
                component.set("v.newWishRequestedParticipant", newWishRequestedParticipant);
            } else if (state === "ERROR") {
    ...
    createWishAffiliation: function (component, event, helper) {
        var newWishAffiliation = JSON.stringify(component.get("v.newWishRequestedParticipant"));
