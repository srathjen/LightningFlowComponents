...
({
    ...
    openCloseModal: function (component, event, helper) {
        ...
        if (isShowModal) {
            ...
            component.set('v.isValidWishParticipantListContactLookup', true);
            component.set('v.isValidWishParticipantListRelatedContactLookup', true);
            component.set('v.modalContactLookupRecordId', '');
            component.set('v.newWishParticipant.Relationship__r.npe4__Contact__c', '');
    ...
    createNewWishAffiliationAction: function (component, event, helper) {
        ...
        var isValidWishParticipantListContactLookup = component.get('v.isValidWishParticipantListContactLookup');
        var isValidWishParticipantListRelatedContactLookup = component.get('v.isValidWishParticipantListRelatedContactLookup');
        ...
        if (showCreateContact) {
            if (isFirstNameValid
                ...
                && isValidWishParticipantListRelatedContactLookup) {
                isValidData = true;
            } else {
                isValidData = false;
            }
        } else {
            if (isValidWishParticipantListContactLookup
                && isRelationshipValid
                && isWishAffiliationTypeValid
                && isValidWishParticipantListRelatedContactLookup) {
                isValidData = true;
    ...
    onChangeValidate: function (component, event, helper) {
         ...
         * Mailing Country cannot be empty when Mailing State is selected
         */
        var wishAffiliationType = component.get("v.newWishParticipant.Wish_Affiliation_Type__c");
        ...
        var wishParticipantListRelatedContactLookup = component.get("v.newWishParticipant.Relationship__r.npe4__Contact__c");
        if (relationshipType === "") {
            component.set('v.isValidRelationshipType', false);
        } else {
            component.set('v.isValidRelationshipType', true);
        }
        if (!wishParticipantListRelatedContactLookup) {
            component.set('v.isValidWishParticipantListRelatedContactLookup', false);
        } else {
            component.set('v.isValidWishParticipantListRelatedContactLookup', true);
        }
        ...
        var showCreateContact = component.get("v.showCreateContact");
        if (showCreateContact) {
            var firstName = component.get("v.newWishParticipant.Contact__r.FirstName");
            var lastName = component.get("v.newWishParticipant.Contact__r.LastName");
            var mailingState = component.get("v.newWishParticipant.Contact__r.MailingState");
            var mailingCountry = component.get("v.newWishParticipant.Contact__r.MailingCountry");
            ...
            if (!modalContactLookupRecordId) {
                component.set('v.isValidWishParticipantListContactLookup', false);
            } else {
                component.set('v.isValidWishParticipantListContactLookup', true);
            }
        }
    ...
    onChangeShowContactAddressForm: function (component) {
        var relationshipContact = component.get("v.newWishParticipant.Relationship__r.npe4__Contact__c");
        var contactResidesWithRelationshipContact = component.get("v.contactResidesWithRelationshipContact");
        var addressOverride = component.get("v.newWishParticipant.Contact__r.npsp__is_Address_Override__c");
        if (relationshipContact) {
            if (contactResidesWithRelationshipContact) {
                if (addressOverride) {
                    ...
                    component.set("v.newWishParticipant.Contact__r.MailingStreet", "");
                    component.set("v.newWishParticipant.Contact__r.MailingCity", "");
                    component.set("v.newWishParticipant.Contact__r.MailingPostalCode", "");
                    component.set("v.newWishParticipant.Contact__r.MailingState", "");
                    component.set("v.newWishParticipant.Contact__r.MailingCountry", "");
                }
            } else {
                component.set("v.newWishParticipant.Contact__r.npsp__is_Address_Override__c", false);
                component.set('v.isAddressOverride', false);
                component.set("v.newWishParticipant.Contact__r.MailingStreet", "");
                component.set("v.newWishParticipant.Contact__r.MailingCity", "");
                component.set("v.newWishParticipant.Contact__r.MailingPostalCode", "");
    ...
    handleLookupSelectedEvent: function (component, event, helper) {
        ...
        if (lookupId === 'wishParticipantListContactLookup') {
            component.set('v.modalContactLookupRecordId', recordId);
            component.set('v.isValidWishParticipantListContactLookup', true);
        } else if (lookupId === 'wishParticipantListRelatedContactLookup') {
            component.set('v.newWishParticipant.Relationship__r.npe4__Contact__c', recordId);
            component.onChangeShowContactAddressForm(component);
            component.set('v.isValidWishParticipantListRelatedContactLookup', true);
