({
    init : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            $A.util.removeClass(component.find('purchaseBody'), 'hidden');
        });
    ...
    submit : function(component, event, helper) {
        ...
        action.setParams({
            ...
            edition: component.get('v.isStandard') ? 'Standard' : 'Business',
            domain: component.get('v.loopUrl'),
            isTest: component.get('v.isTest')
        });
        action.setCallback(this, function(response) {
            var moveToNextStep = component.getEvent('moveToNextStep');
            var errorMessage = "An unexpected error has occurred. Please contact Drawloop Support if this error persists.";
            if (response.getState() === 'SUCCESS') {
                var parsedResponse = JSON.parse(response.getReturnValue());
                if (parsedResponse.status === 'success') {
                    ...
                    if (parsedResponse.ErrorId) {
                        ...
                        errorMessage = responseMessage + ' Include this Error Id if you contact Drawloop Support: ' + parsedResponse.ErrorId;
                    }
