({
	cancel : function(component, event, helper) {
        var cancelEmail = component.getEvent('cancelEmail');
        cancelEmail.fire();
	},
    ...
    updateBody : function(component, event) {
        component.set('v.body', event.source.getElement().value);
    },
    updateHtmlBody : function(component, event) {
        component.set('v.templateHtmlBody', event.source.getElement().value);
    },
