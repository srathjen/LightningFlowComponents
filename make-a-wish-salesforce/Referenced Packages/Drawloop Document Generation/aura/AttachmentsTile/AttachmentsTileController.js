({
    ...
    loadAttachments : function(component, event) {
        var exposeAndLoadAttachments = component.getEvent('exposeAndLoadAttachments');
        exposeAndLoadAttachments.setParams({
            globalIdTag : component.get('v.globalIdTag'),
            attachments : component.get('v.attachments')
        });
        exposeAndLoadAttachments.fire();
    },
